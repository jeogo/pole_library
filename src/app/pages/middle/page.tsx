    ...
    <div className="bg-amber-300 min-h-screen p-4 animate-fadeIn text-black">
      ...
      <header className="flex flex-col items-center mb-8 rtl">
        <div className="flex items-center justify-between w-full">
          ...
          <Link href="/">
            <span className="text-black text-3xl hover:text-gray-700 cursor-pointer transition-transform duration-300 hover:scale-105">
              <FiArrowLeft size={36} />
            </span>
          </Link>
          {/* Logo in the middle */}
          <Image
            ...
            width={100}
            height={100}
            className="w-24 h-24 sm:w-32 sm:h-32 transition-transform duration-300 hover:scale-105"
          />
          {/* Spacer on the right */}
